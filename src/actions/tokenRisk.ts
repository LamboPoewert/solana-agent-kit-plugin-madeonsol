...
export const tokenRiskAction = {
  ...
  description:
    "Get a transparent 0–100 rug-risk/safety score for a Solana token (higher = riskier). Returns a band (safe/caution/danger), an explainable factors[] array (mint authority, freeze authority, liquidity, transfer fee, token-2022, burn, launch cohort, deployer bond rate, KOL signal, blacklist), and the raw inputs that produced the score. PRO/ULTRA only — BASIC receives HTTP 403.",
  examples: [
